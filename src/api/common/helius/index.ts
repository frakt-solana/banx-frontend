...
export const getHeliusPriorityFeeEstimate: GetHeliusPriorityFeeEstimate = async ({
  ...
  const MAX_PRIORITY_FEE_THRESHOLD = 500_000_000
  ...
  try {
      ...
      params: [
        {
          ...
          options: { priorityLevel, evaluateEmptySlotAsZero: true },
        },
      ],
    })
    ...
    //? Prevent fee from exceeding max threshold
    if (fee > MAX_PRIORITY_FEE_THRESHOLD) return MAX_PRIORITY_FEE_THRESHOLD
